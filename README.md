...
The official source code for Interpretable Prototype-based Graph Information Bottleneck at NeurIPS 2023 (https://github.com/sang-woo-seo/PGIB). This repository runs PGIB code on the SPMotif dataset for CPU-only configuration.
